...
namespace CGbR
{
    ...
    public partial class ClassSkeleton : ClassSkeletonBase
    {
#line hidden
        /// <summary>
...
private global::CGbR.AccessModifier _ModifierField;

/// <summary>
/// Access the Modifier parameter of the template.
/// </summary>
private global::CGbR.AccessModifier Modifier
{
    get
    {
...
private string _BaseClassesField;

/// <summary>
/// Access the BaseClasses parameter of the template.
/// </summary>
private string BaseClasses
{
    get
    {
        return this._BaseClassesField;
    }
}
...
bool ModifierValueAcquired = false;
if (this.Session.ContainsKey("Modifier"))
{
    this._ModifierField = ((global::CGbR.AccessModifier)(this.Session["Modifier"]));
    ModifierValueAcquired = true;
}
if ((ModifierValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("Modifier");
    if ((data != null))
    {
        this._ModifierField = ((global::CGbR.AccessModifier)(data));
    }
}
...
bool BaseClassesValueAcquired = false;
if (this.Session.ContainsKey("BaseClasses"))
{
    this._BaseClassesField = ((string)(this.Session["BaseClasses"]));
    BaseClassesValueAcquired = true;
}
if ((BaseClassesValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("BaseClasses");
    if ((data != null))
    {
...
if ((FragmentsValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public class ClassSkeletonBase
    {
        #region Fields
