# CGbR - Code Generator beats Reflection
...
The idea of CGbR is to combine these two offering a reflection similar API but performing dynamic parsing operations 
in the pre-build stage. Using C# partial classes it generates a file _<file_name>.Generated.cs_ that contains
performance optimized static C# classes and properties based on attributes and interfaces defined in the original
class. 
